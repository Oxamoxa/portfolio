    ...
    <div className="relative pb-16">
      ...
      <div className="px-6 pt-20 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
        <div className="max-w-2xl mx-auto lg:mx-0">
          ...
          Ici sont regroupés certains de mes projets, qu'ils soient réalisés seul ou bien en groupe, durant mes années de BTS SIO.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto lg:mx-0">
          ...
          <p className="mt-4 text-zinc-400">
            Articles et ressources sur les dernières avancées en Intelligence Artificielle.
          </p>
        </div>
        <div className="w-full h-px bg-zinc-800" />

        <Card>
          <Link href={`/projects/${veilleInformatique.slug}`}>
            <article className="relative w-full h-full p-4 md:p-8">
              <div className="flex items-center justify-between gap-2">
                <div className="text-xs text-zinc-100">
                  {veilleInformatique.date ? (
                    <time dateTime={new Date(veilleInformatique.date).toISOString()}>
                      {Intl.DateTimeFormat(undefined, {
                        dateStyle: "medium",
                      }).format(new Date(veilleInformatique.date))}
                    </time>
                  ) : (
                    <span>SOON</span>
                  )}
              ...
              <h2
                id="veille-informatique-post"
                className="mt-4 text-3xl font-bold text-zinc-100 group-hover:text-white sm:text-4xl font-display"
              >
                {veilleInformatique.title}
              </h2>
              <p className="mt-4 leading-8 duration-150 text-zinc-400 group-hover:text-zinc-300">
                {veilleInformatique.description}
              </p>
              <br/>
              <div className="absolute bottom-4 md:bottom-8">
                <p className="hidden text-zinc-200 hover:text-zinc-50 lg:block">
